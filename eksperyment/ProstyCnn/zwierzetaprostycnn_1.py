# -*- coding: utf-8 -*-
"""ZwierzetaProstyCNN-1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12YuhBfX9uYtfMhPaPTeI8Y0pY5ouSr_5
"""
...
class ProstyCNN(nn.Module):
    def __init__(self, liczba_klas):
        super(ProstyCNN, self).__init__()
        self.model = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(128, liczba_klas)
        )

    def forward(self, x):
        return self.model(x)

model = ProstyCNN(liczba_klas=liczba_klas).to(device)
